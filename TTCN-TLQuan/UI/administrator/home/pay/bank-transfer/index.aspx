<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="TTCN_TLQuan.UI.administrator.home.pay.bank_transfer.index" %>
...
<body>
    <div class="container" id="bodyContent" runat="server">
        <div class="payment-method">
            <div class="transfer-form">
                <h2>Chuyển khoản qua mã QR</h2>
                <div class="qr-code">
                    <img id="img_qr_bank" runat="server" src="" alt="QR Code">
                </div>
                <div class="btn-coppy">
            ...
            $(document).ready(function () {
                ...
                function checkPayment() {
                    $.ajax({
                        ...
                        data: JSON.stringify({ OrderID: OrderID, content_payment: contentPayment, price: pricePayment }),

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderDetail.aspx.cs" Inherits="TTCN_TLQuan.UI.bar.OrderDetail" %>
...
<body>
    <form runat="server" id="form">
        <div class="container">
            <header class="header">
                <h1 class="tittle" id="nameTable" runat="server">Chi tiết đơn bàn</h1>
            </header>
            <main class="main">
                <table>
                    <thead>
